		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<p id="banner-fixo-texto1">
					<img src="img/dot.png" alt="dot"> <span>CONHEÇA NOSSAS SOLUÇÕES DE CLOUD COMPUTING NO CANADÁ</span> <img src="img/dot.png" alt="dot">
				</p>
				<p id="banner-fixo-texto2">
					Cloud <span>Computing</span> Canadá
				</p>
			</div>
			<div class="col-sm-2">
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<p id="cloud-br-texto1">
					<img src="img/dot.png" alt="dot"> <span>CLOUD SERVER NO CANADÁ</span> <img src="img/dot.png" alt="dot">
				</p>
				<p id="cloud-br-texto2">
					O Melhor em Cloud Server no Canadá
				</p>
