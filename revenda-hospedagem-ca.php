		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<p id="banner-fixo-texto1">
					<img src="img/dot.png" alt="dot"> <span>CONHEÇA NOSSAS SOLUÇÕES DE REVENDA DE HOSPEDAGEM CANADÁ</span> <img src="img/dot.png" alt="dot">
				</p>

				<p id="banner-fixo-texto2">
					Revenda <span>de Hospedagem</span> Canadá
				</p>				
		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<p id="cloud-br-texto1">
					<img src="img/dot.png" alt="dot"> <span>REVENDA DE HOSPEDAGEM NO CANADÁ</span> <img src="img/dot.png" alt="dot">
				</p>

				<p id="cloud-br-texto2">
					O Melhor em Revenda de Hospedagem no Canadá
				</p>
