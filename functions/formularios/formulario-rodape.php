...
$mail->Host = "smtp.nextq.com.br"; // Seu endereço de host SMTP
...
$mail->Username = 'contato@nextq.com.br'; // Conta de email existente e ativa em seu domínio
$mail->Password = '********'; // Senha da sua conta de email

// DADOS DO REMETENTE
$mail->Sender = "contato@nextq.com.br"; // Conta de email existente e ativa em seu domínio
$mail->From = "contato@nextq.com.br"; // Sua conta de email que será remetente da mensagem
$mail->FromName = "Formulário de Contato (Rodapé)"; // Nome da conta de email

// DADOS DO DESTINATÁRIO
$mail->AddAddress('contato@nextq.com.br', 'Contato - NextQ'); // Define qual conta de email receberá a mensagem
