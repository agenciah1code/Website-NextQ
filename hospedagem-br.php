		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<p id="banner-fixo-texto1">
					<img src="img/dot.png" alt="dot"> <span>CONHEÇA NOSSAS SOLUÇÕES HOSPEDAGEM DE SITE NO BRASIL</span> <img src="img/dot.png" alt="dot">
				</p>
				<p id="banner-fixo-texto2">
					Hospedagem <span>de Site</span> Brasil
				</p>
			</div>
			<div class="col-sm-2">
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<p id="cloud-br-texto1">
					<img src="img/dot.png" alt="dot"> <span>HOSPEDAGEM DE SITE NO BRASIL</span> <img src="img/dot.png" alt="dot">
				</p>
				<p id="cloud-br-texto2">
					Sua aplicação merece o melhor
				</p>
					...
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Next Hosp I</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li><strong>Espaço em Disco:</strong> 50GB</li> <br>
									<li><strong>Domínios:</strong> 5</li> <br>
									<li><strong>Caixas Postais:</strong> Ilimitado</li> <br>
									<li><strong>Sub-dominios:</strong> Ilimitado</li> <br>
									<li><strong>Trans. Mensal:</strong> 500GB</li> <br>
									<li><strong>Banco de dados:</strong> Ilimitado</li> <br>
									...
									<li><span>R$ 10,90 mês</span></li> <br>
									<li><button type="button" class="btn btn-padrao" onclick="window.location.href='#'">Contratar</button></li>
								</ul>
							</div>
						</div>
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								...
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Next Hosp II</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li><strong>Espaço em Disco:</strong> 100GB</li> <br>
									<li><strong>Domínios:</strong> 15</li> <br>
									<li><strong>Caixas Postais:</strong> Ilimitado</li> <br>
									<li><strong>Sub-dominios:</strong> Ilimitado</li> <br>
									<li><strong>Trans. Mensal:</strong> 1000GB</li> <br>
									<li><strong>Banco de dados:</strong> Ilimitado</li> <br>
									<li>Suporte 24/7</li> <br>
									<li>Localidade <br> <img src="img/icone_brasil.png" alt="icone_brasil"></li>
									<li>Datacenter <br> <img src="img/tecnologias/equinix.png" alt="equinix"></li> <br> <br>
									<li><span>R$ 19,90 mês</span></li> <br>
									<li><button type="button" class="btn btn-padrao" onclick="window.location.href='#'">Contratar</button></li>
								</ul>
							</div>
						</div>
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Next Hosp III</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li><strong>Espaço em Disco:</strong> 300GB</li> <br>
									<li><strong>Domínios:</strong> 30</li> <br>
									<li><strong>Caixas Postais:</strong> Ilimitado</li> <br>
									<li><strong>Sub-dominios:</strong> Ilimitado</li> <br>
									<li><strong>Trans. Mensal:</strong> 3000GB</li> <br>
									<li><strong>Banco de dados:</strong> Ilimitado</li> <br>
									<li>Suporte 24/7</li> <br>
									<li>Localidade <br> <img src="img/icone_brasil.png" alt="icone_brasil"></li>
									<li>Datacenter <br> <img src="img/tecnologias/equinix.png" alt="equinix"></li> <br> <br>
									<li><span>R$ 29,90 mês</span></li> <br>
									<li><button type="button" class="btn btn-padrao" onclick="window.location.href='#'">Contratar</button></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Next Hosp IV</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li><strong>Espaço em Disco:</strong> 300GB</li> <br>
						...
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Next Hosp V</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li><strong>Espaço em Disco:</strong> 50GB</li> <br>
						...
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Next Hosp VI</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li><strong>Espaço em Disco:</strong> 50GB</li> <br>
			...
			<div class="col-sm-8 text-center">
				...
				<div id="margem-cards-recursos" class="row">
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/painel-de-controle.jpg" alt="painel-de-controle">
								<h5 class="card-title">Painel de Controle</h5>
								<p class="card-text">Completo e fácil de usar.</p>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/multi-plataforma.jpg" alt="multi-plataforma">
								<h5 class="card-title">Multi Plataforma</h5>
								<p class="card-text">Windows e Linux.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/hospedagem-escalavel.jpg" alt="hospedagem-escalavel">
								<h5 class="card-title">Hospedagem Escalável</h5>
								<p class="card-text">Mude de plano a qualquer momento.</p>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/instalador-de-aplicacoes.jpg" alt="instalador-de-aplicacoes">
								<h5 class="card-title">Instalador Automático de Aplicações</h5>
								<p class="card-text">Centenas de recursos disponíveis.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/gestao-de-arquivos.jpg" alt="gestao-de-arquivos">
								<h5 class="card-title">Gestão de Arquivos</h5>
								<p class="card-text">Envie os arquivos do seu site sem depender de software.</p>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/certificado-ssl.jpg" alt="certificado-ssl">
								<h5 class="card-title">Certificado SSL</h5>
								<p class="card-text">Tenha um certificado que prova a segurança do seu site.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/estatisticas.jpg" alt="estatisticas">
								<h5 class="card-title">Estatísticas de Visitação</h5>
								<p class="card-text">Acompanhe a audiência do seu site.</p>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<img src="img/img_hospedagem/migracao-assistida.jpg" alt="migracao-assistida">
								<h5 class="card-title">Migração assistida</h5>
								<p class="card-text">Te ajudamos na migração do site.</p>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card" id="faq1-efeito">
								...
								<div id="faq-item1" class="collapse show" aria-labelledby="faq-1" data-parent="#accordionExample">
									<div class="card-body">
										...
										assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente
										ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim
