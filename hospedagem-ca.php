		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<p id="banner-fixo-texto1">
					<img src="img/dot.png" alt="dot"> <span>CONHEÇA NOSSAS SOLUÇÕES HOSPEDAGEM DE SITE NO CANADÁ</span> <img src="img/dot.png" alt="dot">
				</p>
				<p id="banner-fixo-texto2">
					Hospedagem <span>de Site</span> Canadá
				</p>
			</div>
			<div class="col-sm-2">
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<p id="cloud-br-texto1">
					<img src="img/dot.png" alt="dot"> <span>HOSPEDAGEM DE SITE NO CANADÁ</span> <img src="img/dot.png" alt="dot">
				</p>
				<p id="cloud-br-texto2">
					O Melhor em Hospedagem de Site no Canadá
				</p>
					...
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								...
								<h4 class="my-0 font-weight-normal">Plano I</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li>Espaço em Disco:</li> <br>
									<li>Domínios:</li> <br>
									<li>Caixas Postais:</li> <br>
									<li>Trans. Mensal:</li> <br>
									<li>Banco de dados:</li> <br>
									<li>Suporte 24/7</li> <br>
									<li>Localidade <br> <img src="img/icone_canada.png" alt="icone_canada"></li>
									<li>Datacenter <br> <img src="img/ovh_logo.png" alt="ovh_logo"></li> <br> <br>
									<li><span>R$ 39,90 mês</span></li> <br>
						...
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								...
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Plano II</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li>Espaço em Disco:</li> <br>
									...
									<li>Localidade <br> <img src="img/icone_canada.png" alt="icone_canada"></li>
									<li>Datacenter <br> <img src="img/ovh_logo.png" alt="ovh_logo"></li> <br> <br>
									<li><span>R$ 309,90 mês</span></li> <br>
									<li><button type="button" class="btn btn-padrao" onclick="window.location.href='#'">Contratar</button></li>
								</ul>
							</div>
						</div>
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Plano III</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li>Espaço em Disco:</li> <br>
									...
									<li>Localidade <br> <img src="img/icone_canada.png" alt="icone_canada"></li>
									<li>Datacenter <br> <img src="img/ovh_logo.png" alt="ovh_logo"></li> <br> <br>
									<li><span>R$ 3009,90 mês</span></li> <br>
									<li><button type="button" class="btn btn-padrao" onclick="window.location.href='#'">Contratar</button></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Plano IV</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li>Espaço em Disco:</li> <br>
						...
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Plano V</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li>Espaço em Disco:</li> <br>
						...
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								<img src="img/icone_hospedagem.png" alt="icone_hospedagem">
								<h4 class="my-0 font-weight-normal">Plano VI</h4>
							</div>
							<div class="card-body">
								<ul class="list-unstyled mt-3 mb-4">
									<li>Espaço em Disco:</li> <br>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-8 text-center">
				...
				<p id="recursos-texto3">
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel,
					eleifend sed turpis. Pellentesque cursus arcu id magna euismod in elementum purus molestie.
				</p>
